...
public:
    ...
    std::uint16_t p01000();
    std::uint16_t p06476(std::uint16_t entry = 06476);
    std::uint16_t p10235(std::uint16_t entry = 010235);
    std::uint16_t p07514(std::uint16_t entry = 07514);
    std::uint16_t p12304(std::uint16_t entry = 012304);
